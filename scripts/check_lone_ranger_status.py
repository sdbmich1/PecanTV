#!/usr/bin/env python3
"""
Script to check the current status of The Lone Ranger episodes in the database.
"""
...
def check_lone_ranger_status():
    """Check The Lone Ranger episodes status."""
    print("🔍 Checking The Lone Ranger episodes status")
    print("=" * 50)
    ...
    try:
        ...
        # Get episodes for The Lone Ranger
        cur.execute("""
        ...
        if not episodes:
            print("📺 No episodes found for The Lone Ranger")
            return
