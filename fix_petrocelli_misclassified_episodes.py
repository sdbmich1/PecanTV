    ...
    try:
        ...
        query = text("""
            SELECT id, title, content_url, poster_url, description, release_date, 
                   genre, age_rating, duration, director, cast, rating, 
        ...
        for film in films:
            ...
            genre, age_rating, duration, director, cast, rating, \
            content_uuid, created_at, updated_at = film
            ...
            insert_query = text("""
                INSERT INTO episodes (
                    ...
                    content_url, poster_url, duration, director, cast, 
                    rating, release_date, content_uuid, created_at, updated_at
                ) VALUES (
                    :uuid, :series_id, :episode_number, :title, :description,
                    :content_url, :poster_url, :duration, :director, :cast,
                    :rating, :release_date, :content_uuid, :created_at, :updated_at
