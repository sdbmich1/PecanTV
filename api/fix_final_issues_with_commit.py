#!/usr/bin/env python3
"""
Fix the final issues with proper transaction handling
"""
...
def fix_final_issues_with_commit():
    """Fix the final issues with proper transaction handling"""
    
    with engine.begin() as conn:  # This ensures auto-commit
        print("🔧 Fixing final issues with proper transaction handling...")
        print("=" * 60)
        ...
        """))
        print(f"✅ Updated Dragnet episode 1: {result.rowcount} rows affected")
        ...
        """))
        print(f"✅ Updated Dragnet episode 3: {result.rowcount} rows affected")
        ...
        # 4. Verify the fixes immediately
        print("\n🔍 Verifying fixes...")
        ...
        print("\n✅ All final issues fixed and committed!")

if __name__ == "__main__":
    fix_final_issues_with_commit() 