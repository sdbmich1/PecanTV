#!/usr/bin/env python3
"""
Fix poster URLs to use simple GCS-style endpoint for iOS app compatibility
"""
...
def fix_poster_urls_simple():
    """Fix poster URLs to use simple GCS-style endpoint"""
    
    with engine.begin() as conn:
        print("🔧 Fixing poster URLs to use simple GCS-style endpoint...")
        print("=" * 60)
        
        # Use local server with simple GCS-style paths
        local_server_url = "http://localhost:8000"
        gcs_style_base = f"{local_server_url}/gcs/pecantv_series"
        ...
        print(f"✅ Updated {updated_count} poster URLs to use simple GCS-style endpoint")
        ...
        print(f"\n🌐 Simple GCS-style poster URL format:")
        print(f"  {gcs_style_base}/default_poster.jpg")
        
        print("\n✅ Poster URLs updated to use simple GCS-style endpoint!")

if __name__ == "__main__":
    fix_poster_urls_simple() 