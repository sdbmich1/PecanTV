...
def fix_dragnet_episodes_v3():
    ...
    with engine.connect() as conn:
        ...
        conn.execute(text("""
            INSERT INTO episodes (series_id, season_number, episode_number, title, content_url)
            VALUES (68, 1, 1, 'Dragnet Animated - Episode 1', 'https://storage.googleapis.com/pecantv_series/dragnet/Dragnet14_2p-1080-wCredits.mp4')
        """))
        
        # Add episode 15 as episode 2
        conn.execute(text("""
            INSERT INTO episodes (series_id, season_number, episode_number, title, content_url)
            VALUES (68, 1, 2, 'Dragnet Animated - Episode 2', 'https://storage.googleapis.com/pecantv_series/dragnet/Dragnet15_2p-1080-wCredits.mp4')
        """))
