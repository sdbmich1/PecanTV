#!/usr/bin/env python3
"""
Script to search for entries with 'animate movie' in title
"""
...
def main():
    ...
    print("Searching for entries with 'animate movie' in title...")
    
    # Search for entries with animate movie
    cursor.execute("""
    ...
    if not results:
        print("No entries found with 'animate movie' in title")
        return
